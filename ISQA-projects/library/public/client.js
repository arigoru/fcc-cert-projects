...
function onDOMReady() {
  document.getElementById("commentTest").addEventListener('submit', function(event){
    var id = document.getElementById("idinputtest").value;
    event.target.setAttribute('action',"/api/books/" + id);
  });
